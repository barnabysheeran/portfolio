...
export const ANIMATION_DURATION_QUICK_S: number =
  ANIMATION_DURATION_QUICK_MS / 1000;
export const ANIMATION_DURATION_S: number = ANIMATION_DURATION_MS / 1000;
export const ANIMATION_DURATION_SLOW_S: number =
  ANIMATION_DURATION_SLOW_MS / 1000;
