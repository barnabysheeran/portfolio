...
export default class DotManager {
	...
	getDotIndexAtGrid(positionGridX: number, positionGridY: number): number {
		// Get Grid Data
	...
	fillDot(dotIndex: number) {
		this.#DOTS[dotIndex].fill();
	}

	// ___________________________________________________________________ Clear

	clearDot(dotIndex: number) {
	...
	setSize(displayWidthPx: number, displayHeightPx: number) {
